...
class _SohbetEkraniState extends State<SohbetEkrani> with TickerProviderStateMixin {
  ...
  String? _yerelSelamlasmaMi(String soru) {
    ...
    if (s.contains("saat kaç")) {
      ...
      return "Şu an saat ${now.hour.toString().padLeft(2, '0')}:${now.minute.toString().padLeft(2, '0')} $_hitapSekli. Sizin için ne yapabilirim?";
    }
    if (s.contains("kimsin") || s.contains("sen kimsin") || s.contains("adın ne")) {
      return "Ben ARES, kişisel siberpunk yapay zekâ asistanınızım $_hitapSekli. Sizin için ne yapabilirim?";
    }
    return null;
  }
  ...
  void _cevapVer(String girdi) async {
    ...
    // 2. Selamlaşma değilse API kontrolü yap
    if (_kayitliApiler.isEmpty) {
      setState(() {
        _metin = "Efendim, henüz sisteme bir API anahtarı tanımlanmadı. Lütfen sol üstteki Ayarlar menüsünden Yapay Zeka Havuzu'na girip NVIDIA veya Google anahtarınızı ekleyin.";
        _isProcessing = false;
      });
      if (!_sessizMod) {
        await _tts.speak("Efendim, henüz sisteme bir API anahtarı tanımlanmadı. Lütfen Ayarlar menüsünden Yapay Zeka Havuzu'na girip anahtarınızı ekleyin.");
      }
      return;
    }
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  const Text(
                                    "📚 HAZIR YAPAY ZEKA LİSTESİ (DOKUN VE DOLDUR):",
                      ...
                      Expanded(
                        child: ListView(
                          children: [
                            ...
                            Text("2. YAZI BOYUTU: ${_yaziBoyutu.toInt()} px",
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            _siberpunk3dButon(
                              ...
                              altBaslik: "${_kayitliApiler.length} Yapay Zeka Tanımlı (NVIDIA & Google)",
        ...
        children: [
          Row(
            children: [
              ...
              Text(baslik, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 0.8)),
            ],
          ),
          const SizedBox(height: 2),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(baslik, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 0.6)),
